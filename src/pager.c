                ...
                coordxy x, coordxy y)
{
    ...
    if (mtmp->mfrozen && mtmp->mfrozenr == REASON_PARALYSIS)
        Strcat(buf, ", paralyzed");
    else if (mtmp->msleeping || (mtmp->mfrozen && mtmp->mfrozenr == REASON_SLEEPING))
        Strcat(buf, ", asleep");
    else if(mtmp->mfrozen && mtmp->mfrozenr == REASON_EMPLOYED)
        Strcat(buf, ", busy");
