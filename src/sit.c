    ...
    if (rnd(6) > 4) {
        ...
        case 8:
            ...
            verbalize("By thine Imperious order, %s...",
                      flags.female ? "Dame" : "Sire");
            do_banishment(5); /* REALLY|ONTHRONE, see do_banishment() */
            break;
        case 9:
            /* Magical voice not affected by deafness */
            pline("A voice echoes:");
...
rndcurse(void)
{
    ...
    /*int ahrimaninopeninventory = 0;
    for (obj = gi.invent;; obj = obj->nobj)
        if (obj->oartifact == ART_HEART_OF_AHRIMAN)
        {
            ahrimaninopeninventory = 1;
            break;
        }*/

    if(!u_wield_art(ART_MAGICBANE) && Curse_blocking)
        if ((!Role_if(PM_BARBARIAN) && rn2(2)) || (Role_if(PM_BARBARIAN) && rn2(20))) {
            You(mal_aura, "the magic-absorbing stone");
            return;
        }
    ...
    /*if(ahrimaninopeninventory && !Role_if(PM_BARBARIAN) && rn2(2))
    {
        You(mal_aura, "the magic-absorbing stone");
        return;
    }
    if(ahrimaninopeninventory && Role_if(PM_BARBARIAN) && rn2(20))
    {
        You(mal_aura, "the magic-absorbing stone");
        return;
    }*/
