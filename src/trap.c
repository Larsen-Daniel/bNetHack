    ...
    boolean force)
{
    ...
    boolean bad_geyser_luck = (dilutive_force == 0 || rn2(4) < dilutive_force);
    ...
    if (obj->otyp == CAN_OF_GREASE && obj->spe > 0) {
        ...
        return ER_GREASED;
               ...
               && (!Waterproof_container(obj) || (obj->cursed && !rn2(3))) && bad_geyser_luck) {
        if (in_invent)
        ...
        return ER_DAMAGED;
    } else if ((!force && (Luck + 5) > rn2(20)) || !bad_geyser_luck) {
        /*  chance per item of sustaining damage:
            *   max luck:               10%
            *   avg luck (Luck==0):     75%
            *   awful luck (Luck<-4):  100%
...
drown(void)
{
    ...
    if (u.umonnum == PM_GREMLIN && rn2(3))
        ...
        else if (u.umonnum == PM_STEEL_GOLEM) {
            You("rust.");
            dam = 2 * rn1(25, 25);
        }
        losehp(Maybe_Half_Phys(dam), "rusting away", KILLED_BY);
...
could_untrap(boolean verbosely, boolean check_floor)
{
    ...
    } else if ((!canusehands && !webmaker(gy.youmonst.data))
    ...
    boolean disarm)
{
    ...
    if (Luck > -13 && rn2(13 + Luck) > 7) { /* saved by luck */
        ...
        case 6: {
            ...
            You("are jolted by a surge of electricity%c", Shock_resistance ? '.' : '!');
            if (Shock_resistance) {
                shieldeff(u.ux, u.uy);
