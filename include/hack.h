...
extern int mysterious_force;

extern int strength_type;
extern int sceptre_strength;
extern int special_conflict;
extern int ranger_bonus;
// extern int buffer_len;
// extern int buffer_print_please;
extern int actual_arrow_count;
extern int sacrifice_artifact_number;
extern int crowned_valkyrie;
extern int wizard_in_tower;
extern int silent_archeologist_mode;
extern int last_powerful_message;
extern int positive_message;
extern int its_a_steal;
extern int steal_powerful;
extern int never_saved_before;
extern int recompute;
extern int super_silent_mode;
extern int much_less_powerful;
extern int perm_con_damage;
extern long explevelvals[MAXULEV + 1];
extern int setupexplevelvals;
extern int auto_wizard;
extern int dilutive_force;
extern int boots_bonus;
extern int cloak_bonus;
extern int helmet_bonus;
...
/* we also don't want high-level monsters to hit every single time */
#define adjust_level(x) (x <= 30 ? x : 30 + rnd(x-30))
