...
#define PCHAR2(idx, ch, sym, tilenm, desc, clr) PCHAR(idx, ch, sym, desc, clr)
    ...
    /* start cmap B */
    PCHAR( 32, '|',  S_grave,  "grave", CLR(CLR_LIGHT))
    PCHAR2(33, '\\', S_throne, "throne", "opulent throne", CLR(HI_GOLD))
    PCHAR( 34, '{',  S_sink,   "sink", CLR(CLR_LIGHT))
    ...
    /* start cmap C */
    PCHAR2(75, '*',  S_digbeam, "dig beam", "", CLR(CLR_LIGHT))
    PCHAR2(76, '!',  S_flashbeam, "flash beam", "", CLR(CLR_LIGHT))
