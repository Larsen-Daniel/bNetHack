 ...
 *      alignment, creation/bani flags (G_* defines),
 ...
 *                      order of strength.
 *
 *      Rule #3:        monster frequency is included in the bani mask;
 ...
 */
     ...
     * ants
     */
    MON("giant ant", S_ANT, LVL(2, 18, 5, 0, 0), (G_BANI | G_SGROUP | 3),
    ...
    MON("killer bee", S_ANT, LVL(1, 18, -1, 0, 0), (G_BANI | G_LGROUP | 2),
    ...
    MON("soldier ant", S_ANT, LVL(1, 18, 3, 0, 0), (G_BANI | G_SGROUP | 2),
    ...
    MON("fire ant", S_ANT, LVL(1, 18, 3, 10, 0), (G_BANI | G_SGROUP | 1),
    ...
    MON("giant beetle", S_ANT, LVL(5, 6, 4, 0, 0), (G_BANI | 3),
    ...
    MON("queen bee", S_ANT, LVL(5, 24, -4, 0, 0), (G_BANI | G_NOGEN),
        A(ATTK(AT_STNG, AD_DRST, 1, 8), ATTK(AT_STNG, AD_DRST, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1, 5, MS_BUZZ, MZ_TINY), MR_POISON, MR_POISON,
        M1_ANIMAL | M1_FLY | M1_NOHANDS | M1_OVIPAROUS | M1_POIS,
        M2_HOSTILE | M2_FEMALE | M2_PRINCE, 0, 9, HI_LORD, QUEEN_BEE),
    MON("bullet ant", S_ANT, LVL(1, 18, 3, 0, 0), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), ATTK(AT_STNG, AD_DRST, 6, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(20, 5, MS_SILENT, MZ_TINY), MR_POISON, MR_POISON,
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
        M2_HOSTILE, 0, 12, CLR_CYAN, BULLET_ANT),
    /*
     * blobs
     */
    MON("acid blob", S_BLOB, LVL(1, 3, 8, 0, 0), (G_BANI | 2),
    ...
    MON("quivering blob", S_BLOB, LVL(5, 1, 8, 0, 0), (G_BANI | 2),
        ...
        M2_WANDER | M2_HOSTILE | M2_NEUTER, 0, 6, CLR_LIGHT, QUIVERING_BLOB),
    MON("gelatinous cube", S_BLOB, LVL(6, 6, 8, 0, 0), (G_BANI | 2),
     ...
     * cockatrice
     */
    MON("chickatrice", S_COCKATRICE, LVL(3, 4, 8, 30, 0),
        (G_BANI | G_SGROUP | 1),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, 6, CLR_BROWN, CHICKATRICE),
    MON("cockatrice", S_COCKATRICE, LVL(5, 6, 6, 30, 0), (G_BANI | 5),
    ...
    MON("pyrolisk", S_COCKATRICE, LVL(6, 6, 6, 30, 0), (G_BANI | 1),
     ...
     * dogs & other canines
     */
    MON("jackal", S_DOG, LVL(0, 12, 7, 0, 0), (G_BANI | G_SGROUP | 3),
        ...
        1, CLR_BROWN, JACKAL),
    MON("fox", S_DOG, LVL(0, 15, 7, 0, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_RED, FOX),
    MON("coyote", S_DOG, LVL(1, 12, 7, 0, 0), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
    ...
    MON("werejackal", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
        ...
        WEREJACKAL),
    MON("little dog", S_DOG, LVL(2, 18, 6, 0, 0), (G_BANI | 1),
    ...
    MON("dingo", S_DOG, LVL(4, 16, 5, 0, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 200, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        5, CLR_YELLOW, DINGO),
    MON("dog", S_DOG, LVL(4, 16, 5, 0, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 200, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_DOMESTIC, M3_INFRAVISIBLE,
        5, HI_DOMESTIC, DOG),
    MON("large dog", S_DOG, LVL(6, 15, 4, 0, 0), (G_BANI | 1),
    ...
    MON("wolf", S_DOG, LVL(5, 12, 4, 0, 0), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("winter wolf cub", S_DOG, LVL(5, 12, 4, 0, -5),
        ...
        WINTER_WOLF_CUB),
    MON("warg", S_DOG, LVL(7, 12, 4, 0, -5), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(850, 350, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        8, CLR_BROWN, WARG),
    MON("winter wolf", S_DOG, LVL(7, 12, 4, 20, 0), (G_NOHELL | G_BANI | 1),
    ...
    MON("hell hound", S_DOG, LVL(12, 14, 2, 20, 0), (G_HELL | G_BANI | 1),
     ...
     * eyes
     */
    MON("gas spore", S_EYE, LVL(1, 3, 10, 0, 0), (G_NOCORPSE | G_BANI | 1),
    ...
    MON("floating eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_BANI | 5),
    ...
    MON("shocking sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        (G_NOCORPSE | G_BANI | 2), A(ATTK(AT_EXPL, AD_ELEC, 4, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * felines
     */
    MON("kitten", S_FELINE, LVL(2, 18, 6, 0, 0), (G_BANI | 1),
    ...
    MON("housecat", S_FELINE, LVL(4, 16, 5, 0, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("jaguar", S_FELINE, LVL(4, 15, 6, 0, 0), (G_BANI | 2),
    ...
    MON("lynx", S_FELINE, LVL(5, 15, 6, 0, 0), (G_BANI | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
     ...
     */
    MON("gremlin", S_GREMLIN, LVL(5, 12, 2, 25, -9), (G_BANI | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
        ...
        8, CLR_GREEN, GREMLIN),
    MON("gargoyle", S_GREMLIN, LVL(6, 10, -4, 0, -9), (G_BANI | 2),
    ...
    MON("winged gargoyle", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_BANI | 1),
     ...
     * humanoids
     */
    MON("hobbit", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_BANI | 2),
    ...
    MON("dwarf", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_BANI | 3),
    ...
    MON("bugbear", S_HUMANOID, LVL(3, 9, 5, 0, -6), (G_BANI | 1),
    ...
    MON3("dwarf lord", "dwarf lady", "dwarf leader",
        S_HUMANOID, LVL(4, 6, 10, 10, 5), (G_BANI | 2),
    ...
    MON3("dwarf king", "dwarf queen", "dwarf ruler",
        S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_BANI | 1),
    ...
    MON("mind flayer", S_HUMANOID, LVL(9, 12, 5, 90, -8), (G_BANI | 1),
    ...
    /* MON("manes", S_IMP, LVL(1, 3, 7, 0, -7),
        ...
        MANES), */
    MON("homunculus", S_IMP, LVL(2, 12, 6, 10, -7), (G_BANI | 2),
    ...
    MON("imp", S_IMP, LVL(3, 12, 2, 20, -7), (G_BANI | 1),
    ...
    /* MON("lemure", S_IMP, LVL(3, 3, 7, 0, -7),
        (G_HELL | G_BANI | G_LGROUP | G_NOCORPSE | 1),
    ...
    MON("boggart", S_IMP, LVL(3, 12, 6, 50, -9), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 200, MS_SILENT, MZ_SMALL), 0, 0, M1_HUMANOID,
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_NASTY | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 4, CLR_YELLOW, BOGGART),
    MON("grindylow", S_IMP, LVL(3, 15, 4, 10, -7), (G_BANI | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_TUCH, AD_WRAP, 2, 3), NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 10, MS_SILENT, MZ_TINY), 0, 0, M1_REGEN | M1_SWIM | M1_AMPHIBIOUS, 0,
        M3_INFRAVISIBLE | M3_INFRAVISION, 5, CLR_BLUE, GRINDYLOW),
    MON("ijiraq", S_IMP, LVL(4, 12, 4, 30, 0), (G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_NOPOLY | M2_STALK | M2_STRONG | M2_COLLECT | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 6, CLR_GRAY, IJIRAQ),
    MON("tengu", S_IMP, LVL(6, 13, 5, 30, 7), (G_BANI | 3),
        ...
        7, CLR_CYAN, TENGU),
    MON("quasit", S_IMP, LVL(3, 18, 2, 20, -7), (G_BANI | 2),
        A(ATTK(AT_CLAW, AD_DRDX, 1, 4), ATTK(AT_CLAW, AD_DRDX, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 200, MS_SILENT, MZ_SMALL), MR_POISON, MR_POISON, M1_REGEN | M1_SEE_INVIS,
        M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION, 7, CLR_BLUE, QUASIT),
    /*
     * jellies
     */
    MON("blue jelly", S_JELLY, LVL(4, 0, 8, 10, 0), (G_BANI | 2),
    ...
    MON("spotted jelly", S_JELLY, LVL(5, 0, 8, 10, 0), (G_BANI | 1),
    ...
    MON("ochre jelly", S_JELLY, LVL(6, 3, 8, 20, 0), (G_BANI | 2),
     ...
     * kobolds
     */
    MON("kobold", S_KOBOLD, LVL(0, 6, 10, 0, -2), (G_BANI | 1),
    ...
    MON("large kobold", S_KOBOLD, LVL(1, 6, 10, 0, -3), (G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON3("kobold lord", "kobold lady", "kobold leader",
        S_KOBOLD, LVL(2, 6, 10, 0, -4), (G_BANI | 1),
    ...
    MON("kobold shaman", S_KOBOLD, LVL(2, 6, 6, 10, -4), (G_BANI | 1),
     ...
     * leprechauns
     */
    MON("leprechaun", S_LEPRECHAUN, LVL(5, 15, 8, 20, 0), (G_BANI | 4),
        A(ATTK(AT_CLAW, AD_SGLD, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(120, 60, MS_LAUGH, MZ_SMALL), 0, 0, M1_HUMANOID | M1_TPORT,
        M2_HOSTILE | M2_GREEDY, M3_INFRAVISIBLE, 4, CLR_GREEN, LEPRECHAUN),
    /*
     * mimics
     */
    MON("small mimic", S_MIMIC, LVL(7, 3, 7, 0, 0), (G_BANI | 2),
    ...
    MON("large mimic", S_MIMIC, LVL(8, 3, 7, 10, 0), (G_BANI | 1),
    ...
    MON("giant mimic", S_MIMIC, LVL(9, 3, 7, 20, 0), (G_BANI | 1),
     ...
     * nymphs
     */
    MON("wood nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_BANI | 2),
        ...
        WOOD_NYMPH),
    MON("water nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_BANI | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("mountain nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_BANI | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SEDUCE, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_TPORT,
     ...
     * orcs
     */
    MON("goblin", S_ORC, LVL(0, 6, 10, 0, -3), (G_BANI | 2),
        ...
        GOBLIN),
    MON("hobgoblin", S_ORC, LVL(1, 9, 10, 0, -4), (G_BANI | 2),
     ...
     */
    MON("orc", S_ORC, LVL(1, 9, 10, 0, -3), (G_BANI | G_NOGEN | G_LGROUP),
    ...
    MON("hill orc", S_ORC, LVL(2, 9, 10, 0, -4), (G_BANI | G_LGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Mordor orc", S_ORC, LVL(3, 5, 10, 0, -5), (G_BANI | G_LGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Uruk-hai", S_ORC, LVL(3, 7, 10, 0, -4), (G_BANI | G_LGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("orc shaman", S_ORC, LVL(3, 9, 5, 10, -5), (G_BANI | 1),
    ...
    MON("orc-captain", S_ORC, LVL(5, 5, 10, 0, -5), (G_BANI | 1),
     ...
     * piercers
     */
    MON("rock piercer", S_PIERCER, LVL(3, 1, 3, 0, 0), (G_BANI | 4),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("iron piercer", S_PIERCER, LVL(5, 1, 0, 0, 0), (G_BANI | 2),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("glass piercer", S_PIERCER, LVL(7, 1, 0, 0, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 4, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 300, MS_SILENT, MZ_MEDIUM), MR_ACID, 0,
        M1_CLING | M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_CARNIVORE
            | M1_NOTAKE,
        M2_HOSTILE, 0, 9, CLR_LIGHT, GLASS_PIERCER),
    /*
     * quadrupeds
     */
    MON("rothe", S_QUADRUPED, LVL(2, 9, 7, 0, 0), (G_BANI | G_SGROUP | 4),
        ...
        4, CLR_BROWN, ROTHE),
    MON("mumak", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_BANI | 1),
        ...
        MUMAK),
    MON("leocrotta", S_QUADRUPED, LVL(6, 18, 4, 10, 0), (G_BANI | 2),
    ...
    MON("wumpus", S_QUADRUPED, LVL(8, 3, 2, 10, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("titanothere", S_QUADRUPED, LVL(12, 12, 6, 0, 0), (G_BANI | 2),
        ...
        TITANOTHERE),
    MON("baluchitherium", S_QUADRUPED, LVL(14, 12, 5, 0, 0), (G_BANI | 2),
        ...
        BALUCHITHERIUM),
    MON("mastodon", S_QUADRUPED, LVL(20, 12, 5, 0, 0), (G_BANI | 1),
     ...
     * rodents
     */
    MON("sewer rat", S_RODENT, LVL(0, 12, 7, 0, 0), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 12, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_BROWN, SEWER_RAT),
    MON("giant rat", S_RODENT, LVL(1, 10, 7, 0, 0), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN, GIANT_RAT),
    MON("rabid rat", S_RODENT, LVL(2, 12, 6, 0, 0), (G_BANI | 1),
    ...
    MON("wererat", S_RODENT, LVL(2, 12, 6, 10, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_BROWN,
        WERERAT),
    MON("rock mole", S_RODENT, LVL(3, 3, 0, 20, 0), (G_BANI | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("woodchuck", S_RODENT, LVL(3, 3, 0, 20, 0), (G_NOGEN | G_BANI),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SILENT, MZ_SMALL), 0, 0,
     ...
     */
    MON("cave spider", S_SPIDER, LVL(1, 12, 3, 0, 0), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("centipede", S_SPIDER, LVL(2, 4, 3, 0, 0), (G_BANI | 1),
        A(ATTK(AT_BITE, AD_DRST, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(50, 50, MS_SILENT, MZ_TINY), MR_POISON, MR_POISON,
        M1_CONCEAL | M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_CARNIVORE,
        M2_HOSTILE, 0, 4, CLR_YELLOW, CENTIPEDE),
    MON("giant spider", S_SPIDER, LVL(5, 15, 4, 0, 0), (G_BANI | 1),
    ...
    MON("scorpion", S_SPIDER, LVL(5, 15, 3, 0, 0), (G_BANI | 2),
     ...
     */
    MON("lurker above", S_TRAPPER, LVL(10, 3, 3, 0, 0), (G_BANI | 2),
    ...
    MON("trapper", S_TRAPPER, LVL(12, 3, 3, 0, 0), (G_BANI | 2),
     ...
     * unicorns and horses
     */
    MON("pony", S_UNICORN, LVL(3, 16, 6, 0, 0), (G_BANI | 2),
        ...
        PONY),
    MON("white unicorn", S_UNICORN, LVL(4, 24, 2, 70, 7), (G_BANI | 2),
        ...
        M3_INFRAVISIBLE, 6, CLR_LIGHT, WHITE_UNICORN),
    MON("gray unicorn", S_UNICORN, LVL(4, 24, 2, 70, 0), (G_BANI | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, 6, CLR_GRAY, GRAY_UNICORN),
    MON("black unicorn", S_UNICORN, LVL(4, 24, 2, 70, -7), (G_BANI | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, 6, CLR_BLACK, BLACK_UNICORN),
    MON("horse", S_UNICORN, LVL(5, 20, 5, 0, 0), (G_BANI | 2),
        ...
        HORSE),
    MON("warhorse", S_UNICORN, LVL(7, 24, 4, 0, 0), (G_BANI | 2),
     ...
     * vortices
     */
    MON("fog cloud", S_VORTEX, LVL(3, 1, 0, 0, 0), (G_BANI | G_NOCORPSE | 2),
     ...
     * worms
     */
    MON("baby long worm", S_WORM, LVL(5, 3, 5, 0, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby purple worm", S_WORM, LVL(8, 3, 5, 0, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(600, 250, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_CARNIVORE, M2_HOSTILE, 0,
        9, CLR_MAGENTA, BABY_PURPLE_WORM),
    MON("long worm", S_WORM, LVL(9, 3, 5, 10, 0), (G_BANI | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("purple worm", S_WORM, LVL(15, 9, 6, 20, 0), (G_BANI | 2),
    ...
    MON("xan", S_XAN, LVL(7, 18, -4, 0, 0), (G_BANI | 3),
        A(ATTK(AT_STNG, AD_LEGS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 300, MS_BUZZ, MZ_SMALL), MR_POISON, MR_POISON,
    ...
    MON("yellow light", S_LIGHT, LVL(3, 15, 0, 0, 0),
        (G_NOCORPSE | G_BANI | 4), A(ATTK(AT_EXPL, AD_BLND, 10, 20), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("black light", S_LIGHT, LVL(5, 15, 0, 0, 0),
        (G_NOCORPSE | G_BANI | 2), A(ATTK(AT_EXPL, AD_HALU, 10, 12), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, MS_SILENT, MZ_SMALL),
        MR_FIRE | MR_COLD | MR_ELEC | MR_DISINT | MR_SLEEP | MR_POISON
            | MR_ACID | MR_STONE, 0,
     ...
     * zruty
     */
    MON("zruty", S_ZRUTY, LVL(9, 8, 3, 0, 0), (G_BANI | 2),
    ...
    MON("Angel", S_ANGEL, LVL(14, 10, -4, 55, 12),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 19, CLR_LIGHT, ANGEL),
    ...
    MON("raven", S_BAT, LVL(4, 20, 6, 0, 0), (G_BANI | 2),
    ...
    MON("vampire bat", S_BAT, LVL(5, 20, 6, 0, 0), (G_BANI | 2),
     ...
     * Centaurs
     */
    MON("plains centaur", S_CENTAUR, LVL(4, 18, 4, 0, 0), (G_BANI | 1),
    ...
    MON("forest centaur", S_CENTAUR, LVL(5, 18, 3, 10, -1), (G_BANI | 1),
    ...
    MON("mountain centaur", S_CENTAUR, LVL(6, 20, 2, 10, -3), (G_BANI | 1),
     ...
     */
    MON("baby gray dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        BABY_GRAY_DRAGON),
    MON("baby gold dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
    ...
    MON("baby silver dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        ...
        BABY_SILVER_DRAGON),
    MON("baby shimmering dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M3_DISPLACES, 0, 13, CLR_CYAN,
        BABY_SHIMMERING_DRAGON),
    MON("baby red dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby white dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_COLD, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0, 13, CLR_LIGHT,
        BABY_WHITE_DRAGON),
    MON("baby orange dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        BABY_ORANGE_DRAGON),
    MON("baby black dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        BABY_BLACK_DRAGON),
    MON("baby blue dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        BABY_BLUE_DRAGON),
    MON("baby green dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        BABY_GREEN_DRAGON),
    MON("baby yellow dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_BANI,
        ...
        BABY_YELLOW_DRAGON),
    MON("gray dragon", S_DRAGON, LVL(20, 9, -1, 40, 4), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_MAGM, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
    ...
    MON("gold dragon", S_DRAGON, LVL(19, 6, -3, 40, 4), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_FIRE, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_INFRAVISIBLE, 24, HI_GOLD, GOLD_DRAGON),
    MON("silver dragon", S_DRAGON, LVL(20, 9, -1, 40, 4), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_COLD, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
    ...
    MON("shimmering dragon", S_DRAGON, LVL(20, 9, -1, 70, 4), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_MAGM, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
          | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC | M3_DISPLACES,
        0, 25, CLR_CYAN, SHIMMERING_DRAGON),
    /* red dragon has infravision and can be seen via infravision */
    MON("red dragon", S_DRAGON, LVL(20, 9, -1, 40, -4), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_FIRE, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
    ...
    MON("white dragon", S_DRAGON, LVL(20, 9, -1, 40, -5), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_COLD, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 25, CLR_LIGHT, WHITE_DRAGON),
    MON("orange dragon", S_DRAGON, LVL(20, 9, -1, 40, 5), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_SLEE, 4, 25), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_HUGS, AD_WRAP, 2, 4), NO_ATTK,
          NO_ATTK),
    ...
    MON("black dragon", S_DRAGON, LVL(20, 9, -1, 40, -6), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_DISN, 1, 255), ATTK(AT_BITE, AD_DRLI, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 26, CLR_BLACK, BLACK_DRAGON),
    MON("blue dragon", S_DRAGON, LVL(20, 15, -1, 40, -7), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_ELEC, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
    ...
    MON("green dragon", S_DRAGON, LVL(20, 9, -1, 40, 6), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_DRST, 6, 8), ATTK(AT_BITE, AD_DISE, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 26, CLR_GREEN, GREEN_DRAGON),
    MON("yellow dragon", S_DRAGON, LVL(20, 9, -1, 40, 7), (G_BANI | 1),
        A(ATTK(AT_BREA, AD_ACID, 6, 8), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_NONE, AD_ACID, 4, 8),
          NO_ATTK),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 26, CLR_YELLOW, YELLOW_DRAGON),
    /*
     * Elementals
     */
    MON("stalker", S_ELEMENTAL, LVL(8, 12, 3, 0, 0), (G_BANI | 3),
     ...
     * Fungi
     */
    MON("lichen", S_FUNGUS, LVL(0, 1, 9, 0, 0), (G_BANI | 4),
    ...
    MON("brown mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_BANI | 1),
    ...
    MON("yellow mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_BANI | 2),
    ...
    MON("green mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_BANI | 1),
    ...
    MON("red mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_BANI | 1),
     ...
     * Gnomes
     */
    MON("gnome", S_GNOME, LVL(1, 6, 10, 4, 0), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON3("gnome lord", "gnome lady", "gnome leader",
        S_GNOME, LVL(3, 8, 10, 4, 0), (G_BANI | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("gnomish wizard", S_GNOME, LVL(3, 10, 4, 10, 0), (G_BANI | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
    ...
    MON3("gnome king", "gnome queen", "gnome ruler",
        S_GNOME, LVL(5, 10, 10, 20, 0), (G_BANI | 1),
     ...
     * giant Humanoids
     */
    MON("giant", S_GIANT, LVL(6, 6, 0, 0, 2), (G_BANI | G_NOGEN | 1),
    ...
    MON("stone giant", S_GIANT, LVL(6, 6, 0, 0, 2), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
    ...
    MON("hill giant", S_GIANT, LVL(8, 10, 6, 0, -2), (G_BANI | G_SGROUP | 1),
    ...
    MON("fire giant", S_GIANT, LVL(9, 12, 4, 5, 2), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("frost giant", S_GIANT, LVL(10, 12, 3, 10, -3),
        (G_NOHELL | G_BANI | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 12), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), MR_COLD, MR_COLD,
        M1_HUMANOID | M1_CARNIVORE, M2_GIANT | M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, 13, CLR_LIGHT, FROST_GIANT),
    MON("ettin", S_GIANT, LVL(10, 12, 3, 0, 0), (G_BANI | 1),
    ...
    MON("storm giant", S_GIANT, LVL(16, 12, 3, 10, -3),
        (G_BANI | G_SGROUP | 1), A(ATTK(AT_WEAP, AD_PHYS, 2, 12), NO_ATTK,
                                   NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("minotaur", S_GIANT, LVL(15, 15, 6, 0, 0), (G_BANI | G_NOGEN),
    ...
    MON("jabberwock", S_JABBERWOCK, LVL(15, 12, -2, 50, 0), (G_BANI | 1),
     ...
     * Liches
     */
    MON("lich", S_LICH, LVL(11, 6, 0, 30, -9), (G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_TUCH, AD_DREN, 1, 10), ATTK(AT_MAGC, AD_SPEL, 4, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("demilich", S_LICH, LVL(14, 9, -2, 60, -12),
        (G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_TUCH, AD_DREN, 3, 4), ATTK(AT_MAGC, AD_SPEL, 5, 5), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
        MR_COLD, M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
    ...
    MON("master lich", S_LICH, LVL(17, 9, -4, 90, -15),
        (G_HELL | G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_TUCH, AD_DREN, 3, 6), ATTK(AT_MAGC, AD_SPEL, 6, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("arch-lich", S_LICH, LVL(25, 9, -6, 90, -15),
        (G_HELL | G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_TUCH, AD_DREN, 5, 6), ATTK(AT_MAGC, AD_SPEL, 7, 7), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN),
        MR_FIRE | MR_COLD | MR_SLEEP | MR_ELEC | MR_POISON, MR_FIRE | MR_COLD,
        M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_WANTSBOOK | M3_INFRAVISION,
        30, HI_LORD, ARCH_LICH),
    /*
     * Mummies
     */
    MON("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
        (G_BANI | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_MUMY, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE, M3_INFRAVISION, 5, CLR_BROWN, KOBOLD_MUMMY),
    MON("gnome mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
        (G_BANI | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_MUMY, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_GNOME, M3_INFRAVISION, 6, CLR_RED,
        GNOME_MUMMY),
    MON("orc mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        ...
        M3_INFRAVISION, 7, CLR_GRAY, ORC_MUMMY),
    MON("dwarf mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        ...
        M3_INFRAVISION, 7, CLR_RED, DWARF_MUMMY),
    MON("elf mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_BANI | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_MUMY, 2, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 175, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
        0, M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_ELF, M3_INFRAVISION, 8, CLR_GREEN,
        ELF_MUMMY),
    MON("human mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_MUMY, 2, 4), ATTK(AT_CLAW, AD_MUMY, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE, M3_INFRAVISION, 9, CLR_GRAY,
        HUMAN_MUMMY),
    MON("ettin mummy", S_MUMMY, LVL(7, 12, 4, 30, -6),
        (G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_MUMY, 2, 6), ATTK(AT_CLAW, AD_MUMY, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 250, MS_SILENT, MZ_HUGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_STRONG, M3_INFRAVISION, 10, CLR_BLUE,
        ETTIN_MUMMY),
    MON("giant mummy", S_MUMMY, LVL(8, 14, 3, 30, -7),
        (G_BANI | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_MUMY, 3, 4), ATTK(AT_CLAW, AD_MUMY, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2050, 375, MS_SILENT, MZ_HUGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_GIANT | M2_STRONG | M2_JEWELS,
        M3_INFRAVISION, 11, CLR_CYAN, GIANT_MUMMY),
    /*
     * Nagas
     */
    MON("red naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_BANI,
    ...
    MON("black naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("golden naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, 4, HI_GOLD, GOLDEN_NAGA_HATCHLING),
    MON("guardian naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, 4, CLR_GREEN, GUARDIAN_NAGA_HATCHLING),
    MON("red naga", S_NAGA, LVL(6, 12, 4, 0, -4), (G_BANI | 1),
    ...
    MON("black naga", S_NAGA, LVL(8, 14, 2, 10, 4), (G_BANI | 1),
    ...
    MON("golden naga", S_NAGA, LVL(10, 14, 2, 70, 5), (G_BANI | 1),
    ...
    MON("guardian naga", S_NAGA, LVL(12, 16, 0, 50, 7), (G_BANI | 1),
     ...
     * Ogres
     */
    MON("ogre", S_OGRE, LVL(5, 10, 5, 0, -3), (G_SGROUP | G_BANI | 1),
    ...
    MON3("ogre lord", "ogre lady", "ogre leader",
        S_OGRE, LVL(7, 12, 3, 30, -5), (G_BANI | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON3("ogre king", "ogre queen", "ogre tyrant",
        S_OGRE, LVL(9, 14, 4, 60, -7), (G_BANI | 2),
     ...
     */
    MON("gray ooze", S_PUDDING, LVL(3, 1, 8, 0, 0), (G_BANI | G_NOCORPSE | 2),
     ...
     * Quantum mechanics
     */
    MON("quantum mechanic", S_QUANTMECH, LVL(7, 12, 3, 10, 0), (G_BANI | 3),
    ...
    MON("genetic engineer", S_QUANTMECH, LVL(12, 12, 3, 10, 0), (G_BANI | 1),
     ...
     */
    MON("rust monster", S_RUSTMONST, LVL(5, 18, 2, 0, 0), (G_BANI | 2),
     ...
     * Snakes
     */
    MON("garter snake", S_SNAKE, LVL(1, 8, 8, 0, 0), (G_LGROUP | G_BANI | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("snake", S_SNAKE, LVL(4, 15, 3, 0, 0), (G_BANI | 2),
    ...
    MON("python", S_SNAKE, LVL(6, 3, 5, 0, 0), (G_BANI | 1),
    ...
    MON("pit viper", S_SNAKE, LVL(6, 15, 2, 0, 0), (G_BANI | 1),
    ...
    MON("cobra", S_SNAKE, LVL(6, 18, 2, 0, 0), (G_BANI | 1),
     ...
     * Trolls
     */
    MON("troll", S_TROLL, LVL(7, 12, 4, 0, -3), (G_BANI | 2),
        ...
        9, CLR_BROWN, TROLL),
    MON("ice troll", S_TROLL, LVL(9, 10, 2, 20, -3), (G_NOHELL | G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_COLD, 2, 6),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 300, MS_GRUNT, MZ_LARGE), MR_COLD, MR_COLD,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        12, CLR_LIGHT, ICE_TROLL),
    MON("rock troll", S_TROLL, LVL(9, 12, 0, 0, -3), (G_BANI | 1),
    ...
    MON("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_BANI),
    ...
    MON("Olog-hai", S_TROLL, LVL(13, 12, -4, 0, -7), (G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * Umber hulk
     */
    MON("umber hulk", S_UMBER, LVL(9, 6, 2, 25, 0), (G_BANI | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
    ...
    MON("vampire mage", S_VAMPIRE,
        LVL(20, 14, -4, 50, -9), (G_BANI | G_NOCORPSE | 1),
    ...
    MON("barrow wight", S_WRAITH, LVL(3, 12, 5, 5, -3),
        ...
        BARROW_WIGHT),
    MON("wraith", S_WRAITH, LVL(6, 12, 4, 15, -6), (G_BANI | 2),
     ...
     * Xorn
     */
    MON("xorn", S_XORN, LVL(8, 9, -2, 20, 0), (G_BANI | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
    ...
    MON("monkey", S_YETI, LVL(2, 12, 6, 0, 0), (G_BANI | 1),
        ...
        4, CLR_GRAY, MONKEY),
    MON("ape", S_YETI, LVL(4, 12, 6, 0, 0), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
        ...
        6, CLR_BROWN, APE),
    MON("owlbear", S_YETI, LVL(5, 12, 5, 0, 0), (G_BANI | 3),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
        ...
        OWLBEAR),
    MON("yeti", S_YETI, LVL(5, 15, 6, 0, 0), (G_BANI | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1600, 700, MS_GROWL, MZ_LARGE), MR_COLD, MR_COLD,
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE, M2_HOSTILE | M2_STRONG,
        M3_INFRAVISIBLE, 7, CLR_LIGHT, YETI),
    MON("carnivorous ape", S_YETI, LVL(6, 12, 6, 0, 0), (G_BANI | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON("sasquatch", S_YETI, LVL(7, 15, 6, 0, 2), (G_BANI | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
    ...
    MON("kobold zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_BANI | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("gnome zombie", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        (G_BANI | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 5), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("ghoul", S_ZOMBIE, LVL(3, 6, 10, 0, -2), (G_BANI | G_NOCORPSE | 1),
    ...
    MON("skeleton", S_ZOMBIE, LVL(12, 8, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
        ...
        M2_UNDEAD | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_COLLECT
            | M2_NASTY,
        M3_INFRAVISION, 14, CLR_LIGHT, SKELETON),
    /*
     * golems
     */
    ...
    MON("steel golem", S_GOLEM, LVL(30, 6, 3, 60, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_WEAP, AD_PHYS, 4, 10),
          ATTK(AT_NONE, AD_ENCH, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 0, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT, 0, 34, DRAGON_SILVER, STEEL_GOLEM),
    /*
    ...
    MON("Woodland-elf", S_HUMAN, LVL(4, 12, 10, 10, -5),
        (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_MAGC, AD_ELVN, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 7, CLR_GREEN, WOODLAND_ELF),
    MON("Green-elf", S_HUMAN, LVL(5, 12, 10, 10, -6), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          ATTK(AT_MAGC, AD_ELVN, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 8, CLR_BRIGHT_GREEN, GREEN_ELF),
    MON("Grey-elf", S_HUMAN, LVL(6, 12, 10, 10, -7), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          ATTK(AT_MAGC, AD_ELVN, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 9, CLR_GRAY, GREY_ELF),
    MON3("elf-lord", "elf-lady", "elf-noble",
        S_HUMAN, LVL(8, 12, 10, 20, -9), (G_BANI | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
          ATTK(AT_MAGC, AD_ELVN, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_ELF | M2_STRONG | M2_LORD | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_BRIGHT_BLUE, ELF_NOBLE),
    MON3("Elvenking", "Elvenqueen", "elven monarch",
        S_HUMAN, LVL(9, 12, 10, 25, -10), (G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
          ATTK(AT_MAGC, AD_ELVN, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_ELF | M2_STRONG | M2_PRINCE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 13, CLR_RED, ELVEN_MONARCH),
    MON("High-elf",
        S_HUMAN, LVL(20, 15, 10, 70, -7), (G_BANI | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
          ATTK(AT_MAGC, AD_ELVN, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_ELF | M2_STRONG | M2_PRINCE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 24, HI_LORD, HIGH_ELF),
    MON("doppelganger", S_HUMAN, LVL(9, 12, 5, 20, 0), (G_BANI | 1),
    ...
    MON3("high priest", "high priestess", "high cleric",
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_KICK, AD_PHYS, 2, 8),
          ATTK(AT_MAGC, AD_CLRC, 4, 8), ATTK(AT_MAGC, AD_CLRC, 4, 8), NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_MINION | M2_PRINCE | M2_NASTY | M2_COLLECT
            | M2_MAGIC,
        M3_INFRAVISIBLE, 31, CLR_LIGHT, HIGH_CLERIC),
    MON("soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_BANI | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
    ...
    MON("nurse", S_HUMAN, LVL(11, 6, 0, 0, 0), (G_BANI | 3),
    ...
    MON("lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_BANI | 1),
    ...
    MON("captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_BANI | 1),
    ...
    MON("Charon", S_HUMAN, LVL(76, 18, -5, 120, 0),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_PNAME | M2_MALE | M2_GREEDY
            | M2_COLLECT,
        M3_INFRAVISIBLE, 38, CLR_LIGHT, CHARON),
#endif
    /*
     * ghosts
     */
     ...
     * (major) demons
     */
    MON("jengu", S_DEMON, LVL(8, 12, -4, 30, 0),
        (G_NOCORPSE | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
          ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_DJINNI, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_SWIM,
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_PEACEFUL | M2_FEMALE,
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_BLUE, JENGU),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("erinys", S_DEMON, LVL(9, 12, 2, 30, 10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_RED, ERINYS),
    ...
    MON("ice devil", S_DEMON, LVL(11, 6, -4, 55, -12),
        ...
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 14, CLR_LIGHT, ICE_DEVIL),
    ...
    MON("oni", S_DEMON, LVL(8, 10, 1, 10, 0), (G_HELL | G_LGROUP | 2),
        A(ATTK(AT_WEAP, AD_ELEC, 6, 6), ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1600, 500, MS_SILENT, MZ_LARGE), MR_FIRE | MR_ELEC, 0,
        M1_HUMANOID | M1_CARNIVORE,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_RED, ONI),
    MON("wendigo", S_DEMON, LVL(11, 12, 3, 20, -6), (1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
            ATTK(AT_BITE, AD_FAMN, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), MR_COLD, 0,
        M1_HUMANOID | M1_CARNIVORE,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 13, CLR_GREEN, WENDIGO),
    MON("nuckelavee", S_DEMON, LVL(12, 15, 5, 30, -5), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 3), ATTK(AT_BITE, AD_PEST, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), MR_POISON, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_FLY | M1_SEE_INVIS | M1_CARNIVORE,
        M2_NOPOLY | M2_DEMON | M2_HOSTILE | M2_NASTY | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 14, CLR_BLUE, NUCKELAVEE),
    MON("pishacha", S_DEMON, LVL(13, 12, 4, 60, -14),
        (G_HELL | G_NOCORPSE | 3),
        A(ATTK(AT_BITE, AD_DREN, 3, 8), ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), MR_FIRE | MR_POISON, 0, M1_HUMANOID,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_GRAY, PISHACHA),
    MON("utukku", S_DEMON, LVL(12, 10, 2, 50, -7),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_DRST, 2, 6),
            ATTK(AT_BITE, AD_PEST, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 400, MS_BOOM, MZ_HUGE), MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_DEMON | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT | M2_WANDER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 17, CLR_BLACK, UTUKKU),
    MON("hala", S_DEMON, LVL(15, 15, -5, 60, 5), (G_NOCORPSE | 1),
        A(ATTK(AT_BREA, AD_ELEC, 6, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), MR_ELEC | MR_COLD, 0,
        M1_FLY | M1_SEE_INVIS,
        M2_NOPOLY | M2_DEMON | M2_FEMALE | M2_SHAPESHIFTER,
        0, 18, CLR_BLACK, HALA),
    MON("rakshasa", S_DEMON, LVL(15, 14, -3, 50, -10), (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_GAZE, AD_FIRE, 2, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
            ATTK(AT_BITE, AD_DRLI, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 400, MS_SILENT, MZ_HUGE), MR_COLD | MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 20, CLR_LIGHT, RAKSHASA),
    MON("afrit", S_DEMON, LVL(20, 14, -5, 60, -7), (G_HELL | G_NOCORPSE | 3),
        A(ATTK(AT_MAGC, AD_DJIN, 2, 6), ATTK(AT_MAGC, AD_DJIN, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SPELL, MZ_LARGE), MR_FIRE | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 24, CLR_ORANGE, AFRIT),
    MON("marid", S_DEMON, LVL(33, 15, -14, 90, -14), (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_MAGC, AD_DJIN, 3, 8), ATTK(AT_MAGC, AD_DJIN, 3, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SPELL, MZ_LARGE), MR_FIRE | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 38, CLR_RED, MARID),
    MON("balrog", S_DEMON, LVL(35, 15, -10, 80, -14), (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_FIRE, 12, 6), ATTK(AT_MAGC, AD_SPEL, 4, 4),
          ATTK(AT_MAGC, AD_FIRE, 6, 8), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 42, CLR_RED, BALROG),
    MON("tarasque", S_DEMON, LVL(40, 8, -15, 70, -10), (G_HELL | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 5, 6), ATTK(AT_BITE, AD_PHYS, 6, 8), ATTK(AT_HUGS, AD_WRAP, 10, 10),
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 400, MS_SILENT, MZ_GIGANTIC), MR_FIRE | MR_POISON, MR_POISON,
        M1_SEE_INVIS | M1_POIS | M1_CARNIVORE,
        M2_DEMON | M2_HOSTILE | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 44, CLR_RED, TARASQUE),
    ...
    MON("Yeenoghu", S_DEMON, LVL(56, 18, -5, 80, -15),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_WEAP, AD_CONF, 2, 8),
          ATTK(AT_CLAW, AD_PLYS, 2, 6), ATTK(AT_MAGC, AD_MAGM, 6, 6), NO_ATTK,
          NO_ATTK),
    ...
    MON("Baalzebub", S_DEMON, LVL(89, 9, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_BITE, AD_DRST, 2, 6), ATTK(AT_BITE, AD_DREN, 2, 6),
          ATTK(AT_GAZE, AD_STUN, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_BRIBE, MZ_LARGE), MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_PRINCE | M2_MALE,
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        46, HI_LORD, BAALZEBUB),
    MON("Asmodeus", S_DEMON, LVL(105, 12, -7, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_MAGC, AD_COLD, 6, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Death", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_TUCH, AD_DETH, 8, 12), ATTK(AT_TUCH, AD_DETH, 8, 12), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Pestilence", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_TUCH, AD_PEST, 8, 12), ATTK(AT_TUCH, AD_PEST, 8, 12), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 1, MS_RIDER, MZ_HUMAN),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_HUMANOID | M1_REGEN | M1_SEE_INVIS | M1_TPORT_CNTRL,
    ...
    MON("Famine", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_TUCH, AD_FAMN, 8, 12), ATTK(AT_TUCH, AD_FAMN, 8, 12), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 1, MS_RIDER, MZ_HUMAN),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_HUMANOID | M1_REGEN | M1_SEE_INVIS | M1_TPORT_CNTRL,
    ...
    MON("djinni", S_DEMON, LVL(7, 12, 4, 30, 0), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_MAGC, AD_DJIN, 1, 4), ATTK(AT_MAGC, AD_DJIN, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 400, MS_DJINNI, MZ_HUMAN), MR_POISON | MR_STONE, 0,
        M1_HUMANOID | M1_FLY | M1_POIS, M2_NOPOLY | M2_STALK | M2_COLLECT,
        M3_INFRAVISIBLE, 10, CLR_YELLOW, DJINNI),
    /*
     * sea monsters
     */
    MON("piranha", S_EEL, LVL(2, 18, 4, 0, 0), (G_BANI | G_NOGEN | G_SGROUP),
        ...
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_SLITHY | M1_NOLIMBS
            | M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, 0, 4, CLR_RED, PIRANHA),
    MON("jellyfish", S_EEL, LVL(3, 3, 6, 0, 0), (G_BANI | G_NOGEN),
    ...
    MON("shark", S_EEL, LVL(7, 12, 2, 0, 0), (G_BANI | G_NOGEN),
    ...
    MON("giant eel", S_EEL, LVL(5, 9, -1, 0, 0), (G_BANI | G_NOGEN),
    ...
    MON("electric eel", S_EEL, LVL(7, 10, -3, 0, 0), (G_BANI | G_NOGEN),
    ...
    MON("kraken", S_EEL, LVL(20, 3, 6, 0, -3), (G_BANI | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_HUGS, AD_WRAP, 4, 6), ATTK(AT_BITE, AD_PHYS, 6, 4), NO_ATTK,
          NO_ATTK),
        SIZ(1800, 1000, MS_SILENT, MZ_HUGE), 0, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, 23, CLR_RED,
        KRAKEN),
    /*
     * lizards, &c
     */
    MON("newt", S_LIZARD, LVL(0, 6, 8, 0, 0), (G_BANI | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 20, MS_SILENT, MZ_TINY), 0, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE, 0, 1, CLR_YELLOW, NEWT),
    MON("gecko", S_LIZARD, LVL(1, 6, 8, 0, 0), (G_BANI | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 20, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0, 2, CLR_GREEN,
        GECKO),
    MON("iguana", S_LIZARD, LVL(2, 6, 7, 0, 0), (G_BANI | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SILENT, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0, 3, CLR_BROWN,
        IGUANA),
    MON("baby crocodile", S_LIZARD, LVL(3, 6, 7, 0, 0), G_BANI,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(200, 200, MS_SILENT, MZ_MEDIUM), 0, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE, 0, 4, CLR_BROWN, BABY_CROCODILE),
    MON("lizard", S_LIZARD, LVL(5, 6, 6, 10, 0), (G_BANI | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(40, 40, MS_SILENT, MZ_SMALL), MR_STONE, MR_STONE,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0, 6, CLR_GREEN,
        LIZARD),
    MON("chameleon", S_LIZARD, LVL(6, 5, 6, 10, 0), (G_BANI | 2),
        ...
        CHAMELEON),
    MON("crocodile", S_LIZARD, LVL(6, 9, 5, 0, 0), (G_BANI | 1),
    ...
    MON("Arch Priest", S_HUMAN, LVL(25, 15, 7, 90, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_MALE | M2_COLLECT
            | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 30, CLR_LIGHT, ARCH_PRIEST),
    ...
    MON("Dark One", S_HUMAN, LVL(15, 12, 0, 80, -10),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
          ATTK(AT_CLAW, AD_SAMU, 1, 4), ATTK(AT_MAGC, AD_SPEL, 4, 4), NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
