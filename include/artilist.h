...
static NEARDATA struct artifact artilist[] = {
    ...
    A("Stormbringer", RUNESWORD,
      (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN | SPFX_INTEL | SPFX_DRLI | SPFX_AGGRV), 0, 0,
    ...
    A("Mjollnir", WAR_HAMMER, /* Mjo:llnir */
      (SPFX_RESTR | SPFX_ATTK), 0, 0, ELEC(5, 24), NO_DFNS, NO_CARY, LIGHTNING_BLAST,
    ...
    A("Grimtooth", ORCISH_DAGGER, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAG2),
      ...
      NO_CARY, 0, A_CHAOTIC, PM_ROGUE, PM_ORC, 300L, CLR_RED, GRIMTOOTH),
    /*
    ...
    A("Frost Brand", SHORT_SWORD, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
      COLD(5, 0), COLD(0, 0), NO_CARY, FROST_BLAST, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, FROST_BRAND),

    A("Fire Brand", SHORT_SWORD, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
      FIRE(5, 0), FIRE(0, 0), NO_CARY, FIRE_BLAST, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, FIRE_BRAND),
    ...
    A("Sunsword", LONG_SWORD, (SPFX_RESTR | SPFX_DFLAG2), 0, M2_UNDEAD,
      PHYS(5, 0), DFNS(AD_BLND), NO_CARY, CREATE_LIGHT, A_LAWFUL, NON_PM, NON_PM, 1500L,
      NO_COLOR, SUNSWORD),
    ...
    A("The Heart of Ahriman", LUCKSTONE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_STLTH | SPFX_CRSBLCK), 0,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL,
    ...
    A("The Master Key of Thievery", SKELETON_KEY,
      ...
      STEAL, A_CHAOTIC, PM_ROGUE, NON_PM, 3500L, NO_COLOR,
