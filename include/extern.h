...
extern struct obj *pm_artifact(struct permonst *);
...
extern void recompute_extrinsics(void);
extern void set_artifact_intrinsic_extra(struct obj *, boolean, long);
...
extern boolean is_innate_to_current_form(long *);
...
extern boolean dighole(boolean, boolean, coord *, boolean);
...
extern void set_pinned_arms(int);
extern void heal_arms(void);
...
extern void adj_abon(struct obj *, schar, boolean);
...
extern void save_miscellaneous(NHFILE *);
extern void restore_miscellaneous(NHFILE *);
...
extern int armor_reduction(int);
...
extern int ndemon(aligntyp, struct permonst *);
...
extern struct obj *mkgoodobj_at(char, coordxy, coordxy, boolean, boolean);
...
extern struct obj *mkgoodobj(int, boolean, boolean);
...
extern void actually_givit(struct monst *, int, boolean, boolean);
...
extern void kill_banished_monsters(void);
...
extern boolean onlyarmattacks(struct permonst *);
...
extern int resist_damage(int, int);
extern boolean ubanished(void);
...
extern int throwspell(int);
extern int spell_hit_dice(int);
...
extern boolean u_teleport_mon(struct monst *, boolean, boolean);
...
extern int dosteal(void); // rogue ability
...
extern void mhitm_ad_ssex(struct monst *, struct attack *, struct monst *,
                          struct mhitm_data *);
extern void mhitm_ad_mumy(struct monst *, struct attack *, struct monst *,
                          struct mhitm_data *);
...
extern int smartresist(struct monst *, char, int, int);
