...
#define Pinned u.uprops[PINNED].intrinsic
#define canusehands (!Pinned && !nohands(gy.youmonst.data))
...
#define Flying                                                      \
    ((HFlying || EFlying || (!Upolyd && crowned_valkyrie) || (u.usteed && is_flyer(u.usteed->data))) \
     && !BFlying)
...
#define HSerendipitous u.uprops[SERENDIPITOUS].intrinsic
#define ESerendipitous u.uprops[SERENDIPITOUS].extrinsic
#define Serendipitous (HSerendipitous && !ESerendipitous)
#define Unserendipitous (!HSerendipitous && ESerendipitous)

#define HFerocious u.uprops[FEROCIOUS].intrinsic
#define EFerocious u.uprops[FEROCIOUS].extrinsic
#define Ferocious (HFerocious || EFerocious)
...
#define HCurse_blocking u.uprops[CURSE_BLOCKING].intrinsic
#define ECurse_blocking u.uprops[CURSE_BLOCKING].extrinsic
#define Curse_blocking (HCurse_blocking || ECurse_blocking)
