...
des.object("?")
-- Some monsters.
des.monster({ id = "utukku", x=14,y=12,peaceful=0 })
des.monster({ id = "marid", x=18,y=08,peaceful=0 })
des.monster({ id = "erinys", x=10,y=04,peaceful=0 })
des.monster({ id = "afrit", x=07,y=09,peaceful=0 })
des.monster({ id = "rakshasa", x=27,y=08,peaceful=0 })
-- Moloch's horde
